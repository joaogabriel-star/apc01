...
int main() {
  ...
  float valor_imposto_providencia = valor_salario_bruto * INSS;
  float valor_salario_liquido = valor_salario_bruto - valor_imposto_renda - valor_imposto_providencia;

  printf("--------------------------------\n");
  printf("    C O N T R A C H E Q U E     \n");
  printf("--------------------------------\n");
  printf("Salario Bruto...: R$ \x1b[34m%14.2f\x1b[0m\n", valor_salario_bruto);
  printf("Salario Renda...: R$ \x1b[31m%14.2f\x1b[0m\n", valor_imposto_renda);
  printf("Imposto Previ...: R$ \x1b[31m%14.2f\x1b[0m\n", valor_imposto_providencia);
